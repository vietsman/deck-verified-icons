...
2. Download the latest release [DeckVerifiedIcons-latest.zip](https://github.com/vietsman/deck-verified-icons/releases/download/latest/DeckVerifiedIcons-latest.zip) file.
